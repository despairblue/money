		...
		switch (_p0.ctor) {
			...
			case 'ChangeSafety':
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'ChangeReceivedMoneyForNextMonth':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							receivedMoneyForNextMonth: _elm_lang$core$Basics$not(model.receivedMoneyForNextMonth)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
...
var _user$project$Main$withSetStorage = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2._0;
	var serializedModel = {date: _p3.date, livelihood: _p3.livelihood, safety: _p3.safety, receivedMoneyForNextMonth: _p3.receivedMoneyForNextMonth};
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_p3,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$setStorage(serializedModel),
				_p2._1
			]));
};
var _user$project$Main$SerializedModel = F4(
	function (a, b, c, d) {
		return {date: a, livelihood: b, safety: c, receivedMoneyForNextMonth: d};
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {date: a, livelihood: b, safety: c, receivedMoneyForNextMonth: d, mdl: e};
	});
var _user$project$Main$init = function (serializedModel) {
	var _p4 = serializedModel;
	if (_p4.ctor === 'Just') {
		var _p5 = _p4._0;
		var model = {date: _p5.date, livelihood: _p5.livelihood, safety: _p5.safety, receivedMoneyForNextMonth: _p5.receivedMoneyForNextMonth, mdl: _debois$elm_mdl$Material$model};
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
			_elm_lang$core$Native_List.fromArray(
		...
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			A5(_user$project$Main$Model, 0, 0, 0, false, _debois$elm_mdl$Material$model),
			_elm_lang$core$Native_List.fromArray(
				[]));
	}
};
...
var _user$project$Main$ChangeReceivedMoneyForNextMonth = {ctor: 'ChangeReceivedMoneyForNextMonth'};
...
var _user$project$Main$viewBody = function (model) {
	var balance = function () {
		if (model.receivedMoneyForNextMonth) {
			var updatedModel = _elm_lang$core$Native_Utils.update(
				model,
				{
					date: _user$project$Main$beginningOfNextMonth(model.date)
				});
			return _user$project$Main$calculateBalance(model) + _user$project$Main$calculateBalance(updatedModel);
		} else {
			return _user$project$Main$calculateBalance(model);
		}
	}();
	return A2(
		_elm_lang$html$Html$div,
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'padding-bottom', _1: '2rem'}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$LightBlue, _debois$elm_mdl$Material_Color$S600))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Balance')
											])),
										A2(
										_debois$elm_mdl$Material_Card$subhead,
										_elm_lang$core$Native_List.fromArray(
											[_user$project$Main$white]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									])),
								A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(balance),
													' Euro'))
											]))
									]))
							]))
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Textfield$onInput(_user$project$Main$ChangeLivelyhood),
								_debois$elm_mdl$Material_Textfield$label('Livelihood'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Textfield$onInput(_user$project$Main$ChangeSafety),
								_debois$elm_mdl$Material_Textfield$label('Safety'),
								_debois$elm_mdl$Material_Textfield$floatingLabel,
								_debois$elm_mdl$Material_Textfield$value(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Toggles$onClick(_user$project$Main$ChangeReceivedMoneyForNextMonth),
								_debois$elm_mdl$Material_Toggles$ripple,
								_debois$elm_mdl$Material_Toggles$value(model.receivedMoneyForNextMonth)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
			...
			[_debois$elm_mdl$Material_Layout$fixedHeader]),
		{
			header: _elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Money')
						]))
				]),
